///! Copied straight from the egui_demo_lib crate, as it serves to give a decent indication of performance for this crate.
///! Look in main.rs for the actual example.
